...
<div class="well well-sm">
	...
	{if $is_vip == false || $exprired == true}
		<div class="row">
				<div class="col-sm-3">
					<img class="img-responsive" width="200"src='{$modules_dir}/memberprime/img/vip.png' alt='{l s='Devenez client Vip' mod='memberprime'}'>
				</div>
			    <div class="col-sm-8">

				<h3>{l s='Pas encore membre VIP, profitez d\'avantages avec notre carte VIP !' mod='memberprime'}</h3>
